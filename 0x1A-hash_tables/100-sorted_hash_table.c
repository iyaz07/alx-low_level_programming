...
/**
 * shash_table_create - Func to create a sorted hash table.
 * @size: size of the table.
 *
 * Return: pointer to the hash table created, else NULL
 */
...
/**
 * set_spair - Inserts a node into the hash table.
...
/**
 * set_spair_only - Insert node in head in array
...
/**
 * set_spair_front - sets node to head of given index's list.
 * @ht: pointer to the sorted hash table.
 * @key: the key, a string that cannot be empty.
 * @value: the value associated with the key, can be an empty string.
 * @index: the key's index.
...
/**
 * shash_table_set - Inserts or updates a node to the sorted hash table.
 * @ht: pointer to the sorted hash table.
 * @key: the key..
 * @value: the key, value pair can be an empty string.
 *
...
/**
 * shash_table_get - fetches a value associated with a key.
